...
# 设置主窗口图标
icon_file = resource_path("D:\\a数据库\\有意思的东西\\基因工具\\1.2\\package\\icon.ico")
...
# ===================== 共线性可视化 GUI =====================
from package.Collinearity_Visualization import SyntenyGUI
...
help_menu.add_command(label="关于", command=lambda: messagebox.showinfo("关于", "基因小工具 v1.2\n作者：海是天空的颜色"))
